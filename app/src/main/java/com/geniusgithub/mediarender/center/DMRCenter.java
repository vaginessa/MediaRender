...
public class DMRCenter implements ActionReflectionListener, IDMRAction {
    ...
    public void onRenderSeek(String value, String data) {
        int seekPos = 0;
        try {
            seekPos = DlnaUtils.parseSeekTime(data + "=" + value);
